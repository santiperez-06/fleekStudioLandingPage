      ...
      <div class="container">
        <div class="footer__inner">
          <div class="footer__logo">
            <img class="footer__logo__img" src="/imgs/FLEEK_Completo-01.png" alt="FLEEK studio" />
          </div>
      ...
      <section class="about-page__content">
        <div class="about-page__grid">
          <div class="about-page__logo-col">
            <div class="about-page__isologo">
              <img class="about-page__isologo__img" src="/imgs/FLEEK_Isologo-09.png" alt="" />
            </div>
          </div>
          <div class="about-page__text-col">
            ...
            <p class="about-page__tagline-text">
              WE BUILD ON <span class="about-page__tagline-logo"><img class="about-page__tagline-logo__img" src="/imgs/FLEEK_Logo-05.png" alt="FLEEK" /></span>
            </p>
          </div>
        </div>
      </section>
